...
export default function Header() {
  ...
  return (
    <header className="bg-background text-dark p-4 fixed top-0 w-full">
      <div className="xl:container xl:mx-auto xl:flex xl:justify-between xl:items-center">
        ...
        <div
          className={`${menuOpen ? "" : "translate-x-full"} transition duration-200 w-full absolute top-19 left-0 border-t-2 border-dark xl:translate-0 xl:static xl:border-none xl:w-max xl:flex xl:items-center`}
        >
