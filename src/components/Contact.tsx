  ...
  return (
    <section id="contact" className="border-t border-gray-100 py-19 px-4">
      <div className="xl:container xl:mx-auto">
        ...
        <div className="flex items-center gap-2 py-2 px-4 w-max rounded-full shadow mx-auto mt-10 xl:mt-20">
          <span className="block w-3 h-3 bg-green-400 rounded-full mb-1 animate-pulse"></span>
          <p className="text-dark">Disponível para novos projetos</p>
        </div>
        <div className="text-dark mt-10 text-center xl:mt-20">
        ...
        <div className="mt-10 grid grid-cols-2 max-w-[80%] mx-auto gap-2 xl:mt-20 xl:grid-cols-4 xl:max-w-150">
          {contacts.map((contact) => (
            ...
            >
              ...
              {contact.title === "LinkedIn" && <AiOutlineLinkedin size={24} />}
              {contact.title === "Github" && <VscGithub size={24} />}
              {contact.title === "Whatsapp" && <AiOutlineWhatsApp size={24} />}
